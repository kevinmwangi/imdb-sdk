...
*  ----------------------------------------------------------------*/
export var MainTypename;
(function (MainTypename) {
    MainTypename["Title"] = "Title";
})(MainTypename || (MainTypename = {}));
export var OriginalTitleTextTypename;
...
})(OriginalTitleTextTypename || (OriginalTitleTextTypename = {}));
export var PurpleTypename;
...
})(PurpleTypename || (PurpleTypename = {}));
export var FluffyTypename;
...
})(FluffyTypename || (FluffyTypename = {}));
export var PlotTextTypename;
(function (PlotTextTypename) {
    PlotTextTypename["Markdown"] = "Markdown";
})(PlotTextTypename || (PlotTextTypename = {}));
export var CanRateTypename;
(function (CanRateTypename) {
    CanRateTypename["CanRate"] = "CanRate";
})(CanRateTypename || (CanRateTypename = {}));
export var TentacledTypename;
(function (TentacledTypename) {
    TentacledTypename["CreditEdge"] = "CreditEdge";
})(TentacledTypename || (TentacledTypename = {}));
export var StickyTypename;
(function (StickyTypename) {
    StickyTypename["Cast"] = "Cast";
})(StickyTypename || (StickyTypename = {}));
export var LanguageTypename;
...
})(DisplayablePropertyTypename || (DisplayablePropertyTypename = {}));
export var ID;
(function (ID) {
    ID["Movie"] = "movie";
...
export var ProductionStatusHistoryTypename;
(function (ProductionStatusHistoryTypename) {
    ProductionStatusHistoryTypename["ProductionStatusHistory"] = "ProductionStatusHistory";
})(ProductionStatusHistoryTypename || (ProductionStatusHistoryTypename = {}));
export var DisplayNameTypename;
...
})(DisplayNameTypename || (DisplayNameTypename = {}));
export var AmbitiousTypename;
(function (AmbitiousTypename) {
    AmbitiousTypename["VideoEdge"] = "VideoEdge";
})(AmbitiousTypename || (AmbitiousTypename = {}));
export var CunningTypename;
(function (CunningTypename) {
    CunningTypename["Video"] = "Video";
})(CunningTypename || (CunningTypename = {}));
export var ContentTypeTypename;
(function (ContentTypeTypename) {
    ContentTypeTypename["VideoContentType"] = "VideoContentType";
})(ContentTypeTypename || (ContentTypeTypename = {}));
export var RuntimeTypename;
